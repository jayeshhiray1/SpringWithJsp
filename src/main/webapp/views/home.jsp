...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-white w3-padding w3-card"
			...
			<a href="#home" class="w3-bar-item w3-button">VadaPaav</a>
	...
	<header class="w3-display-container w3-content w3-wide"
		...
		<img class="w3-image" src="https://www.w3schools.com//w3images/hamburger.jpg"
			alt="Hamburger Catering" width="1600" height="800">
		<div class="w3-display-bottomleft w3-padding-large w3-opacity">
			<h1 class="w3-xxlarge">Vada Paav</h1>
		</div>
	</header>
	...
	<div class="w3-content" style="max-width: 1100px">
		...
		<div class="w3-row w3-padding-64" id="menu">
			<div class="w3-col l6 w3-padding-large">
				...
				<br>
				<h4>Bread Basket</h4>
				<p class="w3-text-grey">Assortment of fresh baked fruit breads
					and muffins 5.50</p>
				<br>

				<h4>Honey Almond Granola with Fruits</h4>
				<p class="w3-text-grey">Natural cereal of honey toasted oats,
					raisins, almonds and dates 7.00</p>
				<br>

				<h4>Belgian Waffle</h4>
				<p class="w3-text-grey">Vanilla flavored batter with malted
					flour 7.50</p>
				<br>

				<h4>Scrambled eggs</h4>
				<p class="w3-text-grey">Scrambled eggs, roasted red pepper and
					garlic, with green onions 7.50</p>
				<br>

				<h4>Blueberry Pancakes</h4>
				<p class="w3-text-grey">With syrup, butter and lots of berries
					8.50</p>
			</div>

			<div class="w3-col l6 w3-padding-large">
				<img src="/w3images/tablesetting.jpg"
		...
		<div class="w3-container w3-padding-64" id="contact">
			...
			<form action="/action_page.php" target="_blank">
				...
				<p>
					<input class="w3-input w3-padding-16" type="datetime-local"
						placeholder="Date and time" required name="date"
				...
				<p>
					<button class="w3-button w3-light-grey w3-section" type="submit">SEND
						MESSAGE</button>
				</p>
			</form>
		</div>
